...
def test_add_grow_right():
    ...
    assert bbox_big + bbox_right == BoundingBox(
                                        min=Point(1,2),
                                        max=Point(20,12)
                                    )
def test_add_grow_left():
    ...
    assert bbox_big + bbox_left == BoundingBox(
                                        min=Point(0,2),
                                        max=Point(11,12)
                                    )
...
def test_add_grow_top():
    ...
    assert bbox_big + bbox_top == BoundingBox(
                                       min=Point(1,1),
                                       max=Point(11,12)
                                   )
...
def test_add_grow_bottom():
    ...
    assert bbox_big + bbox_bottom == BoundingBox(
                                       min=Point(1,2),
                                       max=Point(11,13)
                                   )
