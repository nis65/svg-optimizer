...
def test_rects_are_equal():
    assert ( Rect(geometry=GeometryRect(top_left=GeometryPoint(1.5, -2.0), width=2, height=3)) ==
             Rect(geometry=GeometryRect(top_left=GeometryPoint(1.5, -2.0), width=2, height=3))
    )
