...
def test_circles_are_equal():
    assert (Circle(id="circle", geometry=GeometryCircle(center=GeometryPoint(1.5, -2.0), radius=2)) ==
            Circle(id="circle", geometry=GeometryCircle(center=GeometryPoint(1.5, -2.0), radius=2))
    )
