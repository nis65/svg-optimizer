...
class Point:
    ...
    def isclose(self, other: "Point", rel_tol: float = GEOMETRY_REL_TOL, abs_tol: float = GEOMETRY_ABS_TOL):
    ...
    @staticmethod
    def points_are_close(set1: set["Point"], set2: set["Point"], abs_tol: float) -> bool:
