...
class TRHxSDecomposition:
    ...
    def isclose(self, other):
        ...
        return (
            ...
            and math.isclose(
                self.ty, other.ty, rel_tol=GEOMETRY_REL_TOL, abs_tol=GEOMETRY_ABS_TOL
            )
            and math.isclose(
                self.theta_rotate,
                other.theta_rotate,
            ...
            and math.isclose(
                self.sx, other.sx, rel_tol=GEOMETRY_REL_TOL, abs_tol=GEOMETRY_ABS_TOL
            )
            and math.isclose(
                self.sy, other.sy, rel_tol=GEOMETRY_REL_TOL, abs_tol=GEOMETRY_ABS_TOL
            )
        )
...
class Matrix3:
    ...
    def isclose(self, other):
        ...
        return (
            ...
            and math.isclose(
                self.m12, other.m12, rel_tol=GEOMETRY_REL_TOL, abs_tol=GEOMETRY_ABS_TOL
            )
            and math.isclose(
                self.m13, other.m13, rel_tol=GEOMETRY_REL_TOL, abs_tol=GEOMETRY_ABS_TOL
            )
            and math.isclose(
                self.m21, other.m21, rel_tol=GEOMETRY_REL_TOL, abs_tol=GEOMETRY_ABS_TOL
            )
            and math.isclose(
                self.m22, other.m22, rel_tol=GEOMETRY_REL_TOL, abs_tol=GEOMETRY_ABS_TOL
            )
            and math.isclose(
                self.m23, other.m23, rel_tol=GEOMETRY_REL_TOL, abs_tol=GEOMETRY_ABS_TOL
            )
            and math.isclose(
                self.m31, other.m31, rel_tol=GEOMETRY_REL_TOL, abs_tol=GEOMETRY_ABS_TOL
            )
            and math.isclose(
                self.m32, other.m32, rel_tol=GEOMETRY_REL_TOL, abs_tol=GEOMETRY_ABS_TOL
            )
            and math.isclose(
                self.m33, other.m33, rel_tol=GEOMETRY_REL_TOL, abs_tol=GEOMETRY_ABS_TOL
            )
        )
